...
Next steps to make this "complete": train the models (or load real pretrained weights) before running the attacks, and implement an actual targeted-attack path instead of hard-coded example numbers.
